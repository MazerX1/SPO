<template>
  <div class="container">
    ...
    <form class="report-form" @submit.prevent="updateReport">
...
export default {
  ...
  methods: {
    ...
    async updateReport() {
      try {
        await fetch(`http://127.0.0.1:5000/api/reports/${this.report.id}`, {
          method: "PUT",
          headers: {
        ...
        this.$router.push("/"); // Редирект на страницу списка
      } catch (error) {
